...
def main():
    print("🚀 بدء فحص السوق الحقيقي وإرسال ملخص الشروط...")
    
    # رسالة الشروط لتبقى معك مرجعاً في التيليجرام
    intro_msg = (
        f"🤖 *نظام التداول الآلي (ICT/SMC) يعمل الآن*\n"
        f"------------------------------------\n"
        f"📊 *معايير الدخول والشفافية:*\n"
        f"1️⃣ **فلتر الجلسات:** (لندن / نيويورك).\n"
        f"2️⃣ **الاتجاه العام:** مؤشر EMA 200 (فريم 1ساعة).\n"
        f"3️⃣ **الزخم:** مؤشر ADX > 20.\n"
        f"4️⃣ **التأكيد:** اختراق هيكل السوق BOS.\n"
        f"🎯 *البوت يراقب الذهب والعملات الآن بانتظار الفرص.*"
    )
